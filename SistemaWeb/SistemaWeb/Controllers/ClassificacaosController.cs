...
namespace SistemaWeb.Controllers
{
    public class ClassificacaosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdClass,nomec")] Classificacao classificacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdClass,nomec")] Classificacao classificacao)
        {
